...
public class FlightTestData {
    ...
    public static final LocalDateTime requestedDate = of(2022,1,25,15,00);

    public static final Segment seg1 = new Segment(of(2022,1,25,16,00),
            of(2022,1,25,18,00));

    public static final Segment seg2 = new Segment(of(2022,1,23,13,00),
            of(2022,1,25,18,00));

    public static final Segment seg3 = new Segment(of(2022,1,25,16,00),
            of(2022,1,25,18,00));

    public static final Segment seg4 = new Segment(of(2022,1,25,19,00),
            of(2022,1,25,23,00));

    public static final Segment seg5 = new Segment(of(2022,1,26,01,00),
            of(2022,1,26,10,00));

    public static final Segment seg6 = new Segment(of(2022,1,25,16,00),
            of(2022,1,25,11,00));
